...
onMounted(() => {
    articleDetail.value = articleService
    ...
    <el-row :gutter="20">
            ...
            <el-card >
                ...
                <div class="p-[1.3rem] ">
                    ...
                    <div class="item flex items-center w-[100%]">
                        ...
                        <div class="value"><a href="https://xxxxx.cn">https://xxxxx.cn</a></div>
                    </div>
                    <div class="item flex items-center w-[100%]">
                        <div class="label min-w-[2rem]">声明:</div>
                        <div class="value">此文章版权归 7z 所有，如有转载，请注明来自原作者</div>
                    </div>
                </div>
            </el-card>
        </el-col>
        <el-col :sm="6" :xs="0" >
            <el-affix style="width: inherit;" :offset="60">
                <el-card >
                    <div class="max-h-[60vh] p-[1rem]">
                        <MdCatalog :editorId="id" :scrollElement="scrollElement" :scrollElementOffsetTop="65" />
                    </div>
                </el-card>
            </el-affix>
        </el-col>
