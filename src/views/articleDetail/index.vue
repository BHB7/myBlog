...
<template>
  <div class="header" >
    ...
    <div class="bg-center  w-full bg-cover bg-fixed -z-10 top-0 left-0 " :style="{backgroundImage: `url(${articleCont.cover || 'https://cn-sy1.rains3.com/testasd/%E6%97%A0%E6%A0%87%E9%A2%98.png'})`}">

      <div class="inner-header backdrop-blur-2xl flex justify-center items-center">
        <!--LOGO-->
        <svg
          version="1.1"
          class="logo"
